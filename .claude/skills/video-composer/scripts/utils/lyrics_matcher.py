...
class LyricsMatcher:
    ...
    def __init__(self, lyrics_file: Path, transcription: Dict[str, Any], images_dir: Path):
        """
    ...
    def _parse_lyrics(self) -> List[Dict[str, Any]]:
        ...
        for line in lines:
            ...
            if section_match:
                if current_section:
                    sections.append(self._create_section(current_section, current_lyrics, section_count))
    ...
    def _create_section(self, section_name: str, lyrics: List[str], section_count: Dict[str, int]) -> Dict[str, Any]:
    ...
    def _find_section_timing(self, clean_lyrics: str, segments: List[Dict[str, Any]],
                            start_from: float, max_duration: float) -> Tuple[float, float]:
        """
