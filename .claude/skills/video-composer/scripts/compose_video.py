...
def main():
    parser = argparse.ArgumentParser(description='Compose video from images, audio, and lyrics')
    parser.add_argument('--audio', type=Path, required=True, help='Path to audio file')
    parser.add_argument('--lyrics', type=Path, required=True, help='Path to Suno lyrics markdown file')
    parser.add_argument('--images', type=Path, required=True, help='Directory containing section images')
    ...
    transcription_path = work_dir / 'whisper_transcription.json'
